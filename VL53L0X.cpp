...
void VL53L0X::initGPIO()
{
  ...
  if (this->xshutGPIOPin >= 0)
  {
    std::string gpioDirectionFilename =
      std::string("/sys/class/gpio/gpio") + std::to_string(this->xshutGPIOPin) + std::string("/direction");
    this->gpioFilename =
      std::string("/sys/class/gpio/gpio") + std::to_string(this->xshutGPIOPin) + std::string("/value");
